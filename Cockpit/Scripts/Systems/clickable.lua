...
function post_initialize()
    print_message_to_user("TouchScreen Online",10)
...
function detect_aircraft_type(aircraft)
    ...
    if aircraft=="Su-33" or aircraft=="Su-57"or aircraft=="J-11A" or aircraft=="Su-27" then
    return true
    else
    return false
    end
...
function SetCommand(command,value)
    ...
    if aircraft=="Su-27"or aircraft=="Su-57" or aircraft=="MiG-29A"or aircraft=="MiG-29G"or aircraft=="MiG-29S" or aircraft=="Su-25T" then
