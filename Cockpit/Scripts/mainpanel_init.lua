...
cockpit_local_point = {6.35, 10.00, 0.1}
...
IndicatedAirSpeed.arg_number				= 500
IndicatedAirSpeed.input						= {0.0, 5000000}  --m/s
IndicatedAirSpeed.output					= {0.0, 300.0}
